...
export const botAiConfig = {
  timing: {
    ...
    minCompleteResponseMs: intEnv('BOT_MIN_COMPLETE_RESPONSE_MS', 1400),
    minHardCompleteResponseMs: intEnv('BOT_HARD_MIN_COMPLETE_RESPONSE_MS', 1300),
    maxCompleteResponseMs: intEnv('BOT_MAX_COMPLETE_RESPONSE_MS', 11_000),
    minPassMs: intEnv('BOT_MIN_PASS_MS', 2_600),
    maxPassMs: intEnv('BOT_MAX_PASS_MS', 9_500),
    ...
    retryReconsiderMaxMs: intEnv('BOT_RETRY_RECONSIDER_MAX_MS', 2_400),
