...
export const config = {
  ...
  opponentSystem: {
    ...
    trophyMinGain: intEnv('TROPHY_MIN_GAIN', 5),
    trophyMaxGain: intEnv('TROPHY_MAX_GAIN', 43),
    trophyMinLoss: intEnv('TROPHY_MIN_LOSS', 4),
    trophyMaxLoss: intEnv('TROPHY_MAX_LOSS', 48),
