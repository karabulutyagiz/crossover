...
export const SFX_ASSETS: Record<AudioEvent, number> = {
  [AudioEvent.UI_TAP]: require('../../assets/audio/ui/uiTapCorporate.wav'),
  [AudioEvent.UI_NAVIGATION]: require('../../assets/audio/ui/uiNavTickCorporate.wav'),
  [AudioEvent.UI_PRIMARY]: require('../../assets/audio/ui/uiPrimaryCorporate.wav'),
  [AudioEvent.UI_PLAY]: require('../../assets/audio/ui/uiPlay.wav'),
  [AudioEvent.UI_SECONDARY]: require('../../assets/audio/ui/uiSecondaryCorporate.wav'),
  [AudioEvent.UI_CONFIRM]: require('../../assets/audio/ui/uiConfirmCorporate.wav'),
  ...
  [AudioEvent.UI_CLOSE]: require('../../assets/audio/ui/uiCloseCorporate.wav'),
  [AudioEvent.UI_OPEN]: require('../../assets/audio/ui/uiOpen.wav'),
  [AudioEvent.UI_TAB_SWITCH]: require('../../assets/audio/ui/uiTabSwitchCorporate.wav'),
  [AudioEvent.UI_TOGGLE_ON]: require('../../assets/audio/ui/uiToggleOnCorporate.wav'),
  [AudioEvent.UI_TOGGLE_OFF]: require('../../assets/audio/ui/uiToggleOffCorporate.wav'),
  ...
  [AudioEvent.SPLASH_ELECTRIC_IMPACT]: require('../../assets/audio/ui/cofIntroSound.wav'),
  ...
  [AudioEvent.MATCH_START]: require('../../assets/audio/match/matchFoundRefereeWhistleEleven.mp3'),
  ...
  [AudioEvent.MATCHMAKING_FOUND]: require('../../assets/audio/match/matchFoundRefereeWhistleEleven.mp3'),
