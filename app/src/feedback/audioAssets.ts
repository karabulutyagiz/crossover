...
export const SFX_ASSETS: Record<AudioEvent, number> = {
  [AudioEvent.UI_TAP]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
  [AudioEvent.UI_NAVIGATION]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
  [AudioEvent.UI_PRIMARY]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
  [AudioEvent.UI_PLAY]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
  [AudioEvent.UI_SECONDARY]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
  [AudioEvent.UI_CONFIRM]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
  [AudioEvent.UI_NEGATIVE]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
  [AudioEvent.UI_DESTRUCTIVE]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
  [AudioEvent.UI_BACK]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
  [AudioEvent.UI_CLOSE]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
  [AudioEvent.UI_OPEN]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
  [AudioEvent.UI_TAB_SWITCH]: require('../../assets/audio/ui/dragonButtonPress.mp3'),
