...
export const SFX_ASSETS: Record<AudioEvent, number> = {
  [AudioEvent.UI_TAP]: require('../../assets/audio/ui/cofTapSoft.wav'),
  ...
  [AudioEvent.UI_PLAY]: require('../../assets/audio/ui/cofPrimary.wav'),
  [AudioEvent.UI_SECONDARY]: require('../../assets/audio/ui/cofTapSoft.wav'),
  [AudioEvent.UI_CONFIRM]: require('../../assets/audio/ui/cofPrimary.wav'),
  [AudioEvent.UI_NEGATIVE]: require('../../assets/audio/ui/cofBackClose.wav'),
  ...
  [AudioEvent.UI_CLOSE]: require('../../assets/audio/ui/cofBackClose.wav'),
  [AudioEvent.UI_OPEN]: require('../../assets/audio/ui/cofTapSoft.wav'),
  [AudioEvent.UI_TAB_SWITCH]: require('../../assets/audio/ui/cofNavTick.wav'),
  ...
  [AudioEvent.UI_PURCHASE]: require('../../assets/audio/ui/uiPurchasePremium.wav'),
  [AudioEvent.UI_REWARD]: require('../../assets/audio/ui/uiRewardPremium.wav'),
  [AudioEvent.PURCHASE_SUCCESS_TICK]: require('../../assets/audio/progression/purchaseSuccessTick.wav'),
  ...
  [AudioEvent.MATCH_START]: require('../../assets/audio/match/matchStartImpact.wav'),
  ...
  [AudioEvent.MATCHMAKING_FOUND]: require('../../assets/audio/match/matchFoundWhistleClean.wav'),
