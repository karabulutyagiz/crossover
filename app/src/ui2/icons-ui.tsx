...
export function IcNavStore({ size = 40 }: P) {
...
export function IcNavCollection({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcNavPlay({ size = 40 }: P) {
...
export function IcNavFriends({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcTrophy({ size = 40 }: P) {
  return <Box size={size}>
...
// ── HUD ────────────────────────────────────────────────────────────────────────
export function IcGem({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcPlus({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcGear({ size = 40, color = '#3D8BFF' }: P) {
  return <Box size={size}>
...
export function IcGems3({ size = 40 }: P) {
...
export function IcBolt({ size = 40 }: P) {
...
export function IcStar({ size = 40, color = '#FFD21A' }: P) {
...
export function IcFace({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcGift({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcCalendar({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcSuggest({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcAddFriend({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcInviteCode({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcRequests({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcDaily({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcLeague({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcRewards({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcClock({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcClipboard({ size = 40 }: P) {
  return <Box size={size}>
...
export function IcArrowRight({ size = 40, color = '#8CE0FF' }: P) {
...
export function IcChevronGold({ size = 40, color = '#FFB000' }: P) {
...
export function IcCrownBig({ size = 40, color = '#FFD21A', base = '#E0A800' }: P & { base?: string }) {
  return <Box size={size}>
