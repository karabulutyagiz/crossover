...
export function IcMusic({ size = 28, color = '#FFFFFF' }: P) {
...
export function IcSound({ size = 28, color = '#FFFFFF' }: P) {
...
export function IcVibrate({ size = 28, color = '#FFFFFF' }: P) {
...
export function IcBell({ size = 28, color = '#FFD21A' }: P) {
...
export function IcGlobe({ size = 28, color = '#FFFFFF' }: P) {
...
export function IcExit({ size = 28, color = '#FFFFFF' }: P) {
...
export function IcCopy({ size = 28, color = '#FFFFFF' }: P) {
...
export function IcShare({ size = 28, color = '#FFFFFF' }: P) {
...
export function IcCheck({ size = 28, color = '#25D93C' }: P) {
...
export function IcPlus({ size = 28, color = '#25D93C' }: P) {
...
export function IcChevron({ size = 28, color = '#FFFFFF', dir = 'down' }: P & { dir?: 'down' | 'right' | 'left' | 'up' }) {
...
export function IcLock({ size = 28, color = '#FFD21A' }: P) {
...
export function IcClose({ size = 28 }: P) {
...
export function IcModeTeamTeam({ size = 64 }: P) {
...
export function IcModeCountryTeam({ size = 64 }: P) {
...
export function IcModeLetterTeam({ size = 64 }: P) {
...
export function IcModeXox({ size = 64 }: P) {
...
export function IcModeCozKazan({ size = 64 }: P) {
  const L = ['K', 'A', 'Z'];
...
export function IcModeGuessWho({ size = 64 }: P) {
