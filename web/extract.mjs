...
const CLUBS = [
  ...
  // Süper Lig genişlemesi (2026-08): TR-odaklı uzun kuyruk aramaları için.
  // Ekler Türkçe söyleyişe göre: -spor → 'da; iyelikli adlar (Gençlerbirliği,
  // Ankaragücü) → 'nde; Göztepe → 'de; Karagümrük (ötümsüz k) → 'te.
  { id: 126, slug: 'rizespor', name: 'Çaykur Rizespor', short: 'Rizespor', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 820, slug: 'genclerbirligi', name: 'Gençlerbirliği', short: 'Gençlerbirliği', country: 'Türkiye', tier: 2, loc: 'nde' },
  { id: 868, slug: 'ankaragucu', name: 'Ankaragücü', short: 'Ankaragücü', country: 'Türkiye', tier: 2, loc: 'nde' },
  { id: 2293, slug: 'konyaspor', name: 'Konyaspor', short: 'Konyaspor', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 3205, slug: 'kayserispor', name: 'Kayserispor', short: 'Kayserispor', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 2381, slug: 'sivasspor', name: 'Sivasspor', short: 'Sivasspor', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 589, slug: 'antalyaspor', name: 'Antalyaspor', short: 'Antalyaspor', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 10484, slug: 'kasimpasa', name: 'Kasımpaşa', short: 'Kasımpaşa', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 3840, slug: 'adana-demirspor', name: 'Adana Demirspor', short: 'A. Demirspor', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 20, slug: 'bursaspor', name: 'Bursaspor', short: 'Bursaspor', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 152, slug: 'samsunspor', name: 'Samsunspor', short: 'Samsunspor', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 1467, slug: 'goztepe', name: 'Göztepe', short: 'Göztepe', country: 'Türkiye', tier: 2, loc: 'de' },
  { id: 833, slug: 'denizlispor', name: 'Denizlispor', short: 'Denizlispor', country: 'Türkiye', tier: 3, loc: 'da' },
  { id: 2832, slug: 'gaziantep-fk', name: 'Gaziantep FK', short: 'Gaziantep FK', country: 'Türkiye', tier: 3, loc: 'da' },
  { id: 6646, slug: 'fatih-karagumruk', name: 'Fatih Karagümrük', short: 'Karagümrük', country: 'Türkiye', tier: 3, loc: 'te' },
  { id: 11282, slug: 'alanyaspor', name: 'Alanyaspor', short: 'Alanyaspor', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 924, slug: 'istanbulspor', name: 'İstanbulspor', short: 'İstanbulspor', country: 'Türkiye', tier: 3, loc: 'da' },
  { id: 825, slug: 'eskisehirspor', name: 'Eskişehirspor', short: 'Eskişehirspor', country: 'Türkiye', tier: 3, loc: 'da' },
  { id: 7160, slug: 'eyupspor', name: 'Eyüpspor', short: 'Eyüpspor', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 120, slug: 'kocaelispor', name: 'Kocaelispor', short: 'Kocaelispor', country: 'Türkiye', tier: 2, loc: 'da' },
  { id: 7775, slug: 'hatayspor', name: 'Hatayspor', short: 'Hatayspor', country: 'Türkiye', tier: 3, loc: 'da' },
  { id: 2463, slug: 'sakaryaspor', name: 'Sakaryaspor', short: 'Sakaryaspor', country: 'Türkiye', tier: 3, loc: 'da' },
  // England
