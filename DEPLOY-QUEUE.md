...
## ~~SIRA 1 — SUNUCU~~ (ÖLÜ BÖLÜM — 2026-09-04'te doğrulandı)
Bu bölümdeki 10 kalem ZATEN CANLIDA. `sameArenaPair`, `etaSeconds`,
`finishXoxDraw` sembolleri prod'da mevcut. "Seri ödülü sızıntısı sürüyor"
uyarısı da geçersiz. Tarihsel kayıt için bırakıldı, iş listesi DEĞİL.

## ~~SIRA 2 — OTA~~ (ÖLÜ BÖLÜM — bu kalemler 2026-09-02 ve 09-04 OTA'larıyla yayında)
